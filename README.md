...
- **Cheatsheet page** (`cheatsheet.html`) — 13-section dense reference (JS, React+Redux, SQL, Linux, NestJS, TypeScript, DSA, Enterprise Infra Arch, FS Tooling, Docker, Next.js, CI/CD, Redis). Sections 8, 10–13 use labeled sub-section dividers for deep-dive topics (section 9 uses flat grids)
